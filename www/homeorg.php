...
if(($_SERVER['REQUEST_METHOD']=== 'POST')&&isset($_POST['odebrani']))
{
    ...
    $stmtorg->execute([]);
    $sqlvoa="DELETE FROM event where event_key=$id";
...
$existusersa="SELECT event_key from organization_event where organization_key=$session";
            ...
            //count($count)
              ?>
                ...
                <div class="group bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 shadow-md 
                    ...
                    <form action="homeorg.php" method="post">
